  ...
  var Lax = function() {
    ...
    lax.calcTransforms = function(o) {
      ...
      var _loop = function _loop(_i2) {
        ...
        var breakpoint = b[1]
          ? "".concat(breakpointsSeparator).concat(b[1])
          : "";
        a.value.split(" ").forEach(function(p) {
          ...
          if (!fn) {
            console.log(
              "lax error: preset ".concat(bits[0], " is not defined")
            );
          } else {
            var d = fn(bits[1]);
      ...
      if (el.attributes["data-lax-use-gpu"])
        el.attributes.removeNamedItem("data-lax-use-gpu"); // optmise off screen
      ...
      for (var _i3 = 0; _i3 < el.attributes.length; _i3++) {
        ...
        if (bits[1] === "lax") {
          if (_a.name === "data-lax-horizontal") {
            o["data-lax-horizontal"] = true;
          } else if (_a.name === "data-lax-anchor") {
            o["data-lax-anchor"] =
              _a.value === "self" ? el : document.querySelector(_a.value);
            var rect = o["data-lax-anchor"].getBoundingClientRect();
            if (!o["data-lax-horizontal"]) {
              o.anchorTop = Math.floor(rect.top) + window.scrollY;
            }
          } else {
            (function() {
              var tString = _a.value
    ...
    lax.updateElement = function(o) {
      ...
      for (var _i5 in transforms) {
        var transformData =
          transforms[_i5][currentBreakpoint] || transforms[_i5]["default"];
        ...
        var _r = r;
        if (transformData.options.offset)
          _r = _r + transformData.options.offset;
      ...
      if (spriteData) {
        ...
        style.backgroundPosition = "-"
          .concat(framePosX * frameW, "px -")
          .concat(framePosY * frameH, "px");
      }
